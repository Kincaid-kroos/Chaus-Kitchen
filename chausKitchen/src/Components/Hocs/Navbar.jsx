      ...
      <div className='flex items-center justify-between'> 
        ...
        <a className="flex items-center gap-1 italic"  href="/">
         ...
         <div className='hidden md:flex space-x-6 '>
          <a href='#' className="hover:text-[#16B97A]  text-black/70">HOME</a>
          <a href='#' className="hover:text-[#16B97A]  text-black/70">ABOUT US</a>
          <a href='#' className="hover:text-[#16B97A]  text-black/70" >POPULAR MENU`S</a>
          <a href='#' className="hover:text-[#16B97A]  text-black/70">CONTACT US</a>
          </div>
             {/*Item 3*/}
